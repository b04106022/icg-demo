...
if __name__ == '__main__':
    ...
    ap.add_argument("-a", "--animate", type=int, required=False, help="0 = False; 1 = True")
    ...
    points_filename = 'results/landmark/' + name + '.txt'
    ...
    delaunay_file = 'results/delaunay/' + name + '_triangles.txt'
    f = open(delaunay_file, 'w+')
    f.truncate(0)
    triangleList = subdiv.getTriangleList();
    ...
    # Save results
    cv2.imwrite('results/delaunay/' + name + '_delaunay.jpg', img)
    cv2.imwrite('results/delaunay/' + name + '_voronoi.jpg', img_voronoi)
    print('Done! results exported to ' + delaunay_file)
