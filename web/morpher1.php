        ...
        <section class="page-section" id="form">
            <div class="container">
                <div class="text-center">
                    <br><br><h2>Input Two Images</h2>
                    <p>Please input two images. One for source and one for destination.</p><br/><br>   
                </div>
                <form action="../morpher2.php" method="post" enctype="multipart/form-data">
                    <table>
                        <tr>
                            <td>Source Image</td>
